...
extension ThemeColors on ThemeData {
  AppColors get appColors {
    ...
    return AppColors(
      ...
      base4: scheme.surfaceContainerHighest.withOpacity(0.5),
      base5: scheme.onSurface.withOpacity(0.5),
      base6: scheme.onSurface.withOpacity(0.7),
      base7: scheme.onSurface.withOpacity(0.8),
      base8: scheme.onSurface,
      fg: scheme.onSurface,
      fgAlt: scheme.onSurface.withOpacity(0.8),
