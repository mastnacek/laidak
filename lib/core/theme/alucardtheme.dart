...
class AlucardTheme {
  // Barvy pozadí
  static const Color bg = Color(0xFF222330);
  static const Color bgAlt = Color(0xFF222330);
  static const Color base0 = Color(0xFF222330);
  static const Color base1 = Color(0xFF222330);
  ...
  static const Color base6 = Color(0xFFcef3ff);
  static const Color base7 = Color(0xFFcef3ff);
  static const Color base8 = Color(0xFFcef3ff);

  // Foreground barvy
  static const Color fg = Color(0xFFcef3ff);
  static const Color fgAlt = Color(0xFFcef3ff);
  ...
  static const Color green = Color(0xFFfa0074);
  static const Color teal = Color(0xFF50fa7b);
  static const Color yellow = Color(0xFF7f0a1f);
  static const Color blue = Color(0xFF358aff);
  static const Color darkBlue = Color(0xFF1200f8);
  static const Color magenta = Color(0xFF1b3cff);
  static const Color violet = Color(0xFFff78c5);
  static const Color cyan = Color(0xFF0098ff);
  static const Color darkCyan = Color(0xFF8ae9fc);

  /// Vytvořit tmavý ThemeData podle Alucard
