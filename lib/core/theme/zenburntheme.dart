...
class ZenburnTheme {
  ...
  static const Color base2 = Color(0xFF21322f);
  static const Color base3 = Color(0xFF21322f);
  static const Color base4 = Color(0xFF709080);
  static const Color base5 = Color(0xFF87ad9a);
  ...
  // Foreground barvy
  static const Color fg = Color(0xFFdcdccc);
  static const Color fgAlt = Color(0xFFdcdccc);

  // Sémantické barvy
  static const Color grey = Color(0xFF21322f);
  ...
  static const Color teal = Color(0xFFc3bf9f);
  static const Color yellow = Color(0xFFf0deae);
  static const Color blue = Color(0xFFa0c0e0);
  static const Color darkBlue = Color(0xFF94bff3);
  static const Color magenta = Color(0xFFdc8cc3);
  ...
  /// Vytvořit tmavý ThemeData podle Zenburn
