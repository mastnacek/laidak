...
class SolarizedDarkPatchedTheme {
  // Barvy pozadí
  ...
  static const Color base4 = Color(0xFF465a61);
  static const Color base5 = Color(0xFF8cb4c2);
  static const Color base6 = Color(0xFF708183);
  static const Color base7 = Color(0xFF708183);
  static const Color base8 = Color(0xFF708183);

  // Foreground barvy
  static const Color fg = Color(0xFF869b9d);
  static const Color fgAlt = Color(0xFF708183);

  // Sémantické barvy
  static const Color grey = Color(0xFF002731);
  static const Color red = Color(0xFFd01b24);
  static const Color orange = Color(0xFFbd3612);
  static const Color green = Color(0xFF728905);
  static const Color teal = Color(0xFF465a61);
  static const Color yellow = Color(0xFFa57705);
  static const Color blue = Color(0xFF2998ff);
  static const Color darkBlue = Color(0xFF708183);
  static const Color magenta = Color(0xFFc61b6e);
  static const Color violet = Color(0xFF5856b9);
  static const Color cyan = Color(0xFF259185);
  static const Color darkCyan = Color(0xFF81908f);

  /// Vytvořit tmavý ThemeData podle Solarized Dark - Patched
