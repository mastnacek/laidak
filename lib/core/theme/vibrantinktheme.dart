...
class VibrantInkTheme {
  ...
  static const Color red = Color(0xFFff6600);
  static const Color orange = Color(0xFFff0000);
  static const Color green = Color(0xFFccff04);
  static const Color teal = Color(0xFF00ff00);
  static const Color yellow = Color(0xFFffcc00);
  static const Color blue = Color(0xFF44b3cc);
  static const Color darkBlue = Color(0xFF0000ff);
  static const Color magenta = Color(0xFF9933cc);
  static const Color violet = Color(0xFFff00ff);
  static const Color cyan = Color(0xFF44b3cc);
  static const Color darkCyan = Color(0xFF00ffff);

  /// Vytvořit tmavý ThemeData podle VibrantInk
