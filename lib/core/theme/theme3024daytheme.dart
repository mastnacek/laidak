...
class Theme3024DayTheme {
  // Barvy pozadí
  static const Color bg = Color(0xFFf7f7f7);
  static const Color bgAlt = Color(0xFFf7f7f7);
  static const Color base0 = Color(0xFFf7f7f7);
  static const Color base1 = Color(0xFFf7f7f7);
  static const Color base2 = Color(0xFFa4a1a1);
  static const Color base3 = Color(0xFFa4a1a1);
  static const Color base4 = Color(0xFF5b5754);
  static const Color base5 = Color(0xFFffffff);
  static const Color base6 = Color(0xFF494542);
  static const Color base7 = Color(0xFF494542);
  static const Color base8 = Color(0xFF494542);

  // Foreground barvy
  static const Color fg = Color(0xFFffffff);
  static const Color fgAlt = Color(0xFF494542);

  // Sémantické barvy
  static const Color grey = Color(0xFFa4a1a1);
  ...
  static const Color blue = Color(0xFF00577c);
  ...
  static const Color cyan = Color(0xFF5a727a);
  static const Color darkCyan = Color(0xFFccab53);

  /// Vytvořit tmavý ThemeData podle 3024 Day
