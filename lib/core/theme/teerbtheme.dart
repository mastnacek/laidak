...
class TeerbTheme {
  ...
  static const Color base4 = Color(0xFF1c1c1c);
  static const Color base5 = Color(0xFF707070);
  ...
  static const Color red = Color(0xFFd68686);
  static const Color orange = Color(0xFFd68686);
  static const Color green = Color(0xFFaed686);
  static const Color teal = Color(0xFFaed686);
  static const Color yellow = Color(0xFFd7af87);
  static const Color blue = Color(0xFF86aed6);
  static const Color darkBlue = Color(0xFF86aed6);
  static const Color magenta = Color(0xFFd6aed6);
  static const Color violet = Color(0xFFd6aed6);
  static const Color cyan = Color(0xFF8adbb4);
  static const Color darkCyan = Color(0xFFb1e7dd);

  /// Vytvořit tmavý ThemeData podle Teerb
