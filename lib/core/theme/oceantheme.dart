...
class OceanTheme {
  // Barvy pozadí
  static const Color bg = Color(0xFF214fbc);
  static const Color bgAlt = Color(0xFF214fbc);
  static const Color base0 = Color(0xFF214fbc);
  static const Color base1 = Color(0xFF214fbc);
  static const Color base2 = Color(0xFF216dff);
  static const Color base3 = Color(0xFF216dff);
  ...
  // Sémantické barvy
  static const Color grey = Color(0xFF216dff);
  ...
  /// Vytvořit tmavý ThemeData podle Ocean
