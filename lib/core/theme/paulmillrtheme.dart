...
class PaulMillrTheme {
  ...
  static const Color base2 = Color(0xFF414141);
  static const Color base3 = Color(0xFF414141);
  ...
  // Foreground barvy
  static const Color fg = Color(0xFFf1f1f1);
  static const Color fgAlt = Color(0xFFf1f1f1);

  // Sémantické barvy
  static const Color grey = Color(0xFF414141);
  static const Color red = Color(0xFFff0000);
  static const Color orange = Color(0xFFff007f);
  static const Color green = Color(0xFF78ff0e);
  static const Color teal = Color(0xFF66ff66);
  static const Color yellow = Color(0xFFe6be00);
  static const Color blue = Color(0xFF3e73e9);
  static const Color darkBlue = Color(0xFF7099ec);
  static const Color magenta = Color(0xFFb348bd);
  static const Color violet = Color(0xFFda66e5);
  static const Color cyan = Color(0xFF66ccff);
  static const Color darkCyan = Color(0xFF79def1);

  /// Vytvořit tmavý ThemeData podle PaulMillr
