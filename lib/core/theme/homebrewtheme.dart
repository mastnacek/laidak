...
class HomebrewTheme {
  ...
  static const Color base6 = Color(0xFF00ff00);
  static const Color base7 = Color(0xFF00ff00);
  static const Color base8 = Color(0xFF00ff00);

  // Foreground barvy
  static const Color fg = Color(0xFF00ff00);
  static const Color fgAlt = Color(0xFF00ff00);

  // Sémantické barvy
  static const Color grey = Color(0xFF083905);
  static const Color red = Color(0xFF990000);
  ...
  /// Vytvořit tmavý ThemeData podle Homebrew
