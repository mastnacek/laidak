...
class EspressoTheme {
  ...
  static const Color orange = Color(0xFFf00c0c);
  static const Color green = Color(0xFFa4c161);
  static const Color teal = Color(0xFFc1df74);
  static const Color yellow = Color(0xFFffc56d);
  static const Color blue = Color(0xFF74a5c8);
  static const Color darkBlue = Color(0xFF8ab6d9);
  static const Color magenta = Color(0xFFd096d9);
  static const Color violet = Color(0xFFefb5f7);
  static const Color cyan = Color(0xFFbdd6ff);
  static const Color darkCyan = Color(0xFFdbf4ff);

  /// Vytvořit tmavý ThemeData podle Espresso
