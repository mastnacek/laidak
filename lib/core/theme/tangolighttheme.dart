...
class TangoLightTheme {
  ...
  static const Color green = Color(0xFF4e9a05);
  static const Color teal = Color(0xFF8ae234);
  static const Color yellow = Color(0xFFc4a000);
  static const Color blue = Color(0xFF3464a4);
  static const Color darkBlue = Color(0xFF719ecf);
  static const Color magenta = Color(0xFF74507a);
  static const Color violet = Color(0xFFad7ea7);
  static const Color cyan = Color(0xFF037071);
  static const Color darkCyan = Color(0xFF34e2e2);

  /// Vytvořit tmavý ThemeData podle Tango Light
