...
class ArthurTheme {
  ...
  static const Color base4 = Color(0xFF554444);
  static const Color base5 = Color(0xFFfff7f7);
  static const Color base6 = Color(0xFFddeedd);
  static const Color base7 = Color(0xFFddeedd);
  static const Color base8 = Color(0xFFddeedd);

  // Foreground barvy
  static const Color fg = Color(0xFFddeedd);
  static const Color fgAlt = Color(0xFFddeedd);

  // Sémantické barvy
  static const Color grey = Color(0xFF4d4d4d);
  static const Color red = Color(0xFFcd5c5c);
  static const Color orange = Color(0xFFcc5533);
  static const Color green = Color(0xFF86af80);
  static const Color teal = Color(0xFF88aa22);
  static const Color yellow = Color(0xFFe8ae5b);
  static const Color blue = Color(0xFF6495ed);
  static const Color darkBlue = Color(0xFF87ceeb);
  static const Color magenta = Color(0xFFdeb887);
  static const Color violet = Color(0xFF996600);
  static const Color cyan = Color(0xFFb0c4de);
  static const Color darkCyan = Color(0xFFb0c4de);

  /// Vytvořit tmavý ThemeData podle Arthur
