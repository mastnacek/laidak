...
class DesertTheme {
  ...
  static const Color bgAlt = Color(0xFF333333);
  static const Color base0 = Color(0xFF333333);
  static const Color base1 = Color(0xFF333333);
  ...
  static const Color green = Color(0xFF98fb98);
  static const Color teal = Color(0xFF55ff55);
  static const Color yellow = Color(0xFFf0e68c);
  static const Color blue = Color(0xFFdc8f43);
  static const Color darkBlue = Color(0xFF87ceff);
  static const Color magenta = Color(0xFFffdead);
  static const Color violet = Color(0xFFff55ff);
  static const Color cyan = Color(0xFFffa0a0);
  static const Color darkCyan = Color(0xFFffd700);

  /// Vytvořit tmavý ThemeData podle Desert
