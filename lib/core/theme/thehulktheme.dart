...
class TheHulkTheme {
  ...
  static const Color base6 = Color(0xFFb4b4b4);
  static const Color base7 = Color(0xFFb4b4b4);
  static const Color base8 = Color(0xFFb4b4b4);

  // Foreground barvy
  static const Color fg = Color(0xFFcdcdcd);
  static const Color fgAlt = Color(0xFFb4b4b4);

  // Sémantické barvy
  static const Color grey = Color(0xFF4d4f4c);
  static const Color red = Color(0xFF259d1a);
  static const Color orange = Color(0xFF8dff2a);
  static const Color green = Color(0xFF13ce2f);
  static const Color teal = Color(0xFF48ff76);
  static const Color yellow = Color(0xFF62e456);
  static const Color blue = Color(0xFF7c7cff);
  static const Color darkBlue = Color(0xFF4f6a95);
  static const Color magenta = Color(0xFF641e73);
  static const Color violet = Color(0xFF72579d);
  static const Color cyan = Color(0xFF388fac);
  static const Color darkCyan = Color(0xFF3f85a5);

  /// Vytvořit tmavý ThemeData podle The Hulk
