...
class MaterialDarkTheme {
  // Barvy pozadí
  static const Color bg = Color(0xFF222221);
  static const Color bgAlt = Color(0xFF222221);
  static const Color base0 = Color(0xFF222221);
  static const Color base1 = Color(0xFF222221);
  static const Color base2 = Color(0xFFdedede);
  static const Color base3 = Color(0xFFdedede);
  static const Color base4 = Color(0xFF424242);
  static const Color base5 = Color(0xFF424242);
  static const Color base6 = Color(0xFFe4e4e4);
  static const Color base7 = Color(0xFFe4e4e4);
  static const Color base8 = Color(0xFFe4e4e4);

  // Foreground barvy
  static const Color fg = Color(0xFF535353);
  static const Color fgAlt = Color(0xFFe4e4e4);
  ...
  static const Color blue = Color(0xFF269cff);
  ...
  static const Color cyan = Color(0xFF1ad2e8);
  static const Color darkCyan = Color(0xFF26bad1);

  /// Vytvořit tmavý ThemeData podle MaterialDark
