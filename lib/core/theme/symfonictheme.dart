...
class SymfonicTheme {
  ...
  static const Color base4 = Color(0xFF1b1d21);
  static const Color base5 = Color(0xFF6c7484);
  ...
  static const Color orange = Color(0xFFdc322f);
  static const Color green = Color(0xFF56db3a);
  static const Color teal = Color(0xFF56db3a);
  static const Color yellow = Color(0xFFff8400);
  static const Color blue = Color(0xFF0084d4);
  static const Color darkBlue = Color(0xFF0084d4);
  static const Color magenta = Color(0xFFb729d9);
  static const Color violet = Color(0xFFb729d9);
  static const Color cyan = Color(0xFFccccff);
  static const Color darkCyan = Color(0xFFccccff);

  /// Vytvořit tmavý ThemeData podle Symfonic
