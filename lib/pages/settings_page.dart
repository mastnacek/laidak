...
import '../features/profile/presentation/widgets/profile_settings_tab.dart';
...
class _SettingsPageState extends State<SettingsPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _tabController = TabController(length: 8, vsync: this); // 8 tabs (přidán O mně)
  }
    ...
    return Scaffold(
      ...
      body: TabBarView(
        ...
        children: [
          ...
          const ProfileSettingsTab(), // Nový tab O mně
        ],
      ),
    );
  }
