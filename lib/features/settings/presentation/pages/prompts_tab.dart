                          ...
                          Row(
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                ...
                                child: const Text('Uložit', style: TextStyle(fontSize: 14)),
                              ),
                            ],
                          ),
                        ],
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Icon(Icons.add_circle, color: theme.appColors.green, size: 20),
                              const SizedBox(width: 12),
                              Flexible(
                                child: Text(
                                  'Nový prompt',
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                ...
                                child: const Text('Přidat', style: TextStyle(fontSize: 14)),
                              ),
                            ],
                          ),
                        ],
