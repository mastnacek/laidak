...
class SettingsCubit extends Cubit<SettingsState> {
  ...
  Future<void> setMotivationProviderRoute(ProviderRoute route) async {
    ...
    try {
      ...
      // Update state
      emit(currentState.copyWith(aiMotivationProviderRoute: route));
  ...
  Future<void> setMotivationEnableCache(bool enabled) async {
    ...
    try {
      ...
      // Update state
      emit(currentState.copyWith(aiMotivationEnableCache: enabled));
  ...
  Future<void> setTaskProviderRoute(ProviderRoute route) async {
    ...
    try {
      ...
      // Update state
      emit(currentState.copyWith(aiTaskProviderRoute: route));
  ...
  Future<void> setTaskEnableCache(bool enabled) async {
    ...
    try {
      ...
      // Update state
      emit(currentState.copyWith(aiTaskEnableCache: enabled));
  ...
  Future<void> setRewardProviderRoute(ProviderRoute route) async {
    ...
    try {
      ...
      // Update state
      emit(currentState.copyWith(aiRewardProviderRoute: route));
  ...
  Future<void> setRewardEnableCache(bool enabled) async {
    ...
    try {
      ...
      // Update state
      emit(currentState.copyWith(aiRewardEnableCache: enabled));
  ...
  Future<void> setTagSuggestionsProviderRoute(ProviderRoute route) async {
    ...
    try {
      ...
      // Update state
      emit(currentState.copyWith(aiTagSuggestionsProviderRoute: route));
  ...
  Future<void> setTagSuggestionsEnableCache(bool enabled) async {
    ...
    try {
      ...
      // Update state
      emit(currentState.copyWith(aiTagSuggestionsEnableCache: enabled));
  ...
  ///
  /// Exportuje:
  /// - Settings table (API keys, modely, themy, delimitery)
  /// - Custom prompts
  /// - Custom agenda views + notes views
  /// - Tag definitions
  /// - Export config (SharedPreferences)
  ///
  /// Returns: Cesta k exportovanému souboru nebo null při chybě/zrušení
  ...
  /// - Export config (SharedPreferences)
  ///
  /// Strategie: REPLACE - přepsat všechna existující nastavení
  ///
  /// Returns: true při úspěchu, false při chybě/zrušení
  Future<bool> importAllSettings() async {
    ...
    try {
      ...
      if (success) {
        ...
        // ⚠️ DŮLEŽITÉ: Reload settings po importu (refresh Cubit state)
        await loadSettings();
