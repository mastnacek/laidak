...
final class Todo extends Equatable {
  ...
  final int? aiMotivationGeneratedAt; // Unix timestamp (seconds)
  ...
  /// Business logika: Je úkol opakující se?
  bool get hasRecurrence => recurrenceRule != null;
